...
/**
 * Comparator designed to help sort actors by average path lengths from least to greatest 
 * @author Armando Ortiz, Dartmouth College, CS10, Fall 2018
 *
 */
public class AvgPathComparator implements Comparator<String> {
	private Graph<String, Set<String>> graph;
	
	public AvgPathComparator(Graph<String, Set<String>> graph) {
		this.graph = graph;
	}
